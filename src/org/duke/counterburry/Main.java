...
public class Main extends Application{
  ...
  public void start(Stage stage) throws Exception {
    ...
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/res/fxml/Core.fxml"));
    Pane root_pane = fxmlLoader.load();
    //tentons de créer les objets url et  ResourceBundle vides , donc nuls
    URL fm = null;
    ResourceBundle messages = null;
    //fin de création
    CoreController controller = fxmlLoader.getController();
    controller.SetPrimaryStage(stage);
    controller.initialize(fm,messages);
    stage.setTitle("Calcul Convivial");
    stage.setScene(new Scene(root_pane, 874, 622));
    stage.show();
    }
